...
function useSettingsInternal() {
  ...
  useEffect(() => {
    ...
    const model = localTranscriptionProvider === "nvidia" ? parakeetModel :
      localTranscriptionProvider === "intel-npu" ? store.npuModel : whisperModel;
    window.electronAPI
